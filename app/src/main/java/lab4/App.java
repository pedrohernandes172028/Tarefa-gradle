...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Jogo jogo = new Jogo(heroi, mapa, noAtual, scanner);
        jogo.iniciar();
    ...
    private static Mapa criarMapa() {
        ...
        inimigos1.add(new Cobrinha("Cobra Guardiã", 12, 6, 8, 10));
        ...
        inimigos2.add(new Cobrinha("Cobra Venenosa", 15, 7, 12, 12));
        inimigos2.add(new Cobrinha("Cobra Pequena", 8, 4, 6, 8));
        Batalha batalha2 = new Batalha(inimigos2);
        NoMapa no2 = new NoMapa(batalha2, "Clareira Escura");
        
        List<Inimigo> inimigos3 = new ArrayList<>();
        inimigos3.add(new Cobrinha("Cobra Gigante", 20, 8, 15, 7));
        ...
        inimigos4.add(new Cobrinha("Cobra Rainha", 25, 10, 18, 15));
        inimigos4.add(new Cobrinha("Cobra Guardiã", 12, 6, 8, 10));
        inimigos4.add(new Cobrinha("Cobra Venenosa", 15, 7, 12, 12));
        ...
        inimigos5.add(new Cobrinha("Cobra Anciã", 30, 12, 20, 18));
